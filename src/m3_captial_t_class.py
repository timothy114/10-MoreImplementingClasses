...
class CapitalT(object):
    ...
    def __init__(self, intersection_center, width, height, letter_thickness):
        ...
        # --------------------------------------------------------------
        h_rect_corner_1 = rg.Point(intersection_center.x-(width/2),intersection_center.y-(letter_thickness/2))
        h_rect_corner_2 = rg.Point(intersection_center.x+(width/2),intersection_center.y+(letter_thickness/2))
        self.h_rect = rg.Rectangle(h_rect_corner_1,h_rect_corner_2)

        v_rect_corner_1 = rg.Point(intersection_center.x-(letter_thickness/2),intersection_center.y-(letter_thickness/2))
        v_rect_corner_2 = rg.Point(intersection_center.x+(letter_thickness/2),intersection_center.y-(letter_thickness/2)+height)
